...
* ✅ **Works across images, text, tabular data, etc.** **Private Evolution** can generate synthetic data for various data types, including images, text, and tabular data. More data modalities are coming soon!
...
**This library is the official Python package of Private Evolution**. It allows you to generate differentially private synthetic data (e.g., images, text, tabular data) using the **Private Evolution** algorithm. This library is designed to be easy to use, flexible, modular, and extensible. It provides several popular foundation models and data synthesis tools, and you can easily extend it to work with your own foundation models (and/or APIs), data synthesis tools, data types, or new **Private Evolution** algorithms if needed.
