...
:py:class:`pe.histogram.histogram.Histogram` is responsible for generating the histograms over the synthetic samples. It has the following key methods:

* :py:meth:`pe.histogram.histogram.Histogram.compute_histogram`: Generates the histograms over the synthetic samples using private samples.
