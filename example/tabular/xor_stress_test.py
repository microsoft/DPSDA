...
if __name__ == "__main__":
    ...
    exp_folder = f"results/tabular/xor_stress_test_{num_features}_features"
    ...
    tab_classifier = TabClassifier(
        test_data=test_data, model_name="tabpfn", filter_criterion={VARIATION_API_FOLD_ID_COLUMN_NAME: -1}
    )
