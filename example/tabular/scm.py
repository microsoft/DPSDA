...
if __name__ == "__main__":
    ...
    parser.add_argument("--prior-function", type=str, default="tree", choices=["tree", "nn", "rff"])
    ...
    priv_data = TabularCSV(
        ...
        f"heads/main/tabular/sim/scm/{prior_function}/data_train.csv",
        metadata_path="https://raw.githubusercontent.com/toan-vt/cloud-data-store/refs/"
        f"heads/main/tabular/sim/scm/{prior_function}/metadata.json",
    )
    priv_info = priv_data.get_tab_info()

    test_data = TabularCSV(
        csv_path="https://raw.githubusercontent.com/toan-vt/cloud-data-store/refs/"
        f"heads/main/tabular/sim/scm/{prior_function}/data_test.csv",
        metadata_path="https://raw.githubusercontent.com/toan-vt/cloud-data-store/refs/"
        f"heads/main/tabular/sim/scm/{prior_function}/metadata.json",
    )
