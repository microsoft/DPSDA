...
class SaveTabToCSV(Callback):
    ...
    def __call__(self, syn_data):
        ...
        """
        execution_logger.info("Saving the synthetic tabular data to a CSV file")

        feature_columns = syn_data.metadata["feature_columns"]
        ...
        execution_logger.info("Finished saving the synthetic tabular data to a CSV file")
